...
def _build_database_properties() -> dict[str, dict]:
    ...
    add(mapping.get("importance", ""), {"select": {}})
    add(mapping.get("citation_count", ""), {"number": {}})
    add(mapping.get("url", ""), {"url": {}})
    add(mapping.get("published_date", ""), {"date": {}})
    add(mapping.get("added_date", ""), {"date": {}})
    add(mapping.get("created_time", ""), {"created_time": {}})
    add(mapping.get("last_edited_time", ""), {"last_edited_time": {}})
